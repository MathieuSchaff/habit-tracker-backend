...
export const COLIBRI_PRODUCT_SLUGS = {
...
export const COLIBRI_PRODUCT_DATA = [
  {
    name: 'Brightening Booster',
    brand: 'Colibri Skincare',
    kind: 'skincare',
    unit: 'pump',
    slug: COLIBRI_PRODUCT_SLUGS.COLIBRI_BRIGHTENING_BOOSTER,
    totalAmount: 50,
    amountUnit: 'ml',
    priceCents: 2471,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: COLIBRI_PRODUCT_SLUGS.PORE_CONTROL_BOOSTER,
    totalAmount: 50,
    amountUnit: 'ml',
    priceCents: 2795,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: COLIBRI_PRODUCT_SLUGS.CALMING_MOISTURIZER,
    totalAmount: 80,
    amountUnit: 'ml',
    priceCents: 2695,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: COLIBRI_PRODUCT_SLUGS.VITAMIN_C_20_BOOSTER,
    totalAmount: 30,
    amountUnit: 'ml',
    priceCents: 3295,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: COLIBRI_PRODUCT_SLUGS.VITAMIN_C15_BOOSTER,
    totalAmount: 30,
    amountUnit: 'ml',
    priceCents: 2195,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: COLIBRI_PRODUCT_SLUGS.BARRIER_BOOSTER,
    totalAmount: 50,
    amountUnit: 'ml',
    priceCents: 2471,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: COLIBRI_PRODUCT_SLUGS.ANTIOXIDANT_SERUM,
    totalAmount: 30,
    amountUnit: 'ml',
    priceCents: 2595,
    description:
