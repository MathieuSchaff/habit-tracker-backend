...
export const TONERS_PRODUCT_SLUGS = {
...
export const TONERS_PRODUCT_DATA = [
  {
    name: 'Black Rice Hyaluronic Toner Fragrance Free',
    brand: 'haruharu wonder',
    kind: 'skincare',
    unit: 'pump',
    slug: TONERS_PRODUCT_SLUGS.HARUHARU_BLACK_RICE_HYALURONIC_FF,
    totalAmount: 150,
    amountUnit: 'ml',
    priceCents: 892,
    description:
...

  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: TONERS_PRODUCT_SLUGS.IM_FROM_RICE_TONER,
    totalAmount: 150,
    amountUnit: 'ml',
    priceCents: 2170,
    description:
...

  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: TONERS_PRODUCT_SLUGS.EQQUALBERRY_SWIMMING_POOL,
    totalAmount: 300,
    amountUnit: 'ml',
    priceCents: 1517,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: TONERS_PRODUCT_SLUGS.MIXSOON_CENTELLA_ASIATICA,
    totalAmount: 300,
    amountUnit: 'ml',
    priceCents: 1250,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: TONERS_PRODUCT_SLUGS.NUMBUZIN_NO9_NAD_PDRN_GLOW,
    totalAmount: 150,
    amountUnit: 'ml',
    priceCents: 1200,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: TONERS_PRODUCT_SLUGS.NUMBUZIN_NO1_PURE_FULL_CALMING,
    totalAmount: 300,
    amountUnit: 'ml',
    priceCents: 1891,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: TONERS_PRODUCT_SLUGS.NUMBUZIN_NO5_GLUTATHIONE_VITAMIN,
    totalAmount: 200,
    amountUnit: 'ml',
    priceCents: 1600,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: TONERS_PRODUCT_SLUGS.ROUND_LAB_1025_DOKDO,
    totalAmount: 200,
    amountUnit: 'ml',
    priceCents: 1300,
    description:
