...
export const MIXA_PRODUCT_SLUGS = {
...
export const MIXA_PRODUCT_DATA = [
  {
    name: 'Crème Niacinamide Correction Éclat',
    brand: 'Mixa',
    kind: 'skincare',
    unit: 'pump',
    slug: MIXA_PRODUCT_SLUGS.NIACINAMIDE_CORRECTION_ECLAT,
    totalAmount: 400,
    amountUnit: 'ml',
    priceCents: 790,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: MIXA_PRODUCT_SLUGS.ACIDE_HYALURONIQUE_FRAICHE,
    totalAmount: 400,
    amountUnit: 'ml',
    priceCents: 442,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: MIXA_PRODUCT_SLUGS.PEAUX_SECHES_SENSIBLES,
    totalAmount: 400,
    amountUnit: 'ml',
    priceCents: 443,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: MIXA_PRODUCT_SLUGS.PANTHENOL_CONFORT,
    totalAmount: 400,
    amountUnit: 'ml',
    priceCents: 682,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: MIXA_PRODUCT_SLUGS.CERAMIDE_PROTECTION,
    totalAmount: 400,
    amountUnit: 'ml',
    priceCents: 631,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: MIXA_PRODUCT_SLUGS.CICA_REPARATION,
    totalAmount: 400,
    amountUnit: 'ml',
    priceCents: 642,
    description:
  ...
  },
  {
    ...
    kind: 'skincare',
    unit: 'pump',
    slug: MIXA_PRODUCT_SLUGS.PEAUX_TRES_SECHES_TERNES,
    totalAmount: 400,
    amountUnit: 'ml',
    priceCents: 452,
    description:
